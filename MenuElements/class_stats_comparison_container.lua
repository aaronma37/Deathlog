...
for _, v in ipairs(average_class_subtitles) do
	...
	average_class_header_font_strings[v[1]]:SetFont(normalFont, 15, "")
...
for k, class_id in pairs(class_tbl) do
	...
	for _, v in ipairs(average_class_subtitles) do
		...
		average_class_font_strings[class_id][v[1]]:SetFont(normalFont, 14, "")
...
for _, v in ipairs(average_class_subtitles) do
	...
	average_class_font_strings["all"][v[1]]:SetFont(normalFont, 14, "")
...
function average_class_container.updateMenuElement(scroll_frame, inc_class_id, stats_tbl, setMapRegion, model, view)
	...
	if average_class_container.heading == nil then
		...
		average_class_container.heading:SetFont(normalFont, 18, "")
	...
	if average_class_container.milestone_text == nil then
		...
		average_class_container.milestone_text:SetFont(normalFont, 12, "")
	...
	if average_class_container.x_hint == nil then
		...
		average_class_container.x_hint:SetFont(normalFont, 12, "")
