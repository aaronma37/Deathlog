...
local function drawLogTab(container)
	...
	font_container.server_dd.text:SetFont(normalFont, 12, "")
	...
	font_container.race_dd.text:SetFont(normalFont, 12, "")
	...
	font_container.class_dd.text:SetFont(normalFont, 12, "")
	...
	font_container.zone_dd.text:SetFont(normalFont, 12, "")
	...
	font_container.instance_dd.text:SetFont(normalFont, 12, "")
	...
	font_container.min_level_box:SetFont(normalFont, 14, "")
	...
	font_container.min_level_box.text:SetFont(normalFont, 12, "")
	...
	font_container.max_level_box:SetFont(normalFont, 14, "")
	...
	font_container.max_level_box.text:SetFont(normalFont, 12, "")
	...
	font_container.player_search_box:SetFont(normalFont, 14, "")
	...
	font_container.player_search_box.text:SetFont(normalFont, 12, "")
	...
	font_container.guild_search_box:SetFont(normalFont, 14, "")
	...
	font_container.guild_search_box.text:SetFont(normalFont, 12, "")
	...
	font_container.death_source_box:SetFont(normalFont, 14, "")
	...
	font_container.death_source_box.text:SetFont(normalFont, 12, "")
	...
	font_container.last_words_check_box.text:SetFont(normalFont, 12, "")
	...
	if font_container.page_str == nil then
		...
		font_container.page_str:SetFont(normalFont, 14, "")
...
local function drawCreatureStatisticsTab(container)
	...
	title_label.label:SetFont(normalFont, 24, "")
	...
	description_label.label:SetFont(normalFont, 14, "")
